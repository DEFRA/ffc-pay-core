...
export DEBT_ENRICHMENT_EMAILS=__EMAIL_PLACEHOLDER__
export INVALID_BANK_DETAILS_EMAILS=__EMAIL_PLACEHOLDER__
export CORE_SOLUTIONS_TEAM_EMAILS=__EMAIL_PLACEHOLDER__
export SFI_EMAILS=__EMAIL_PLACEHOLDER__
export ES_EMAILS=__EMAIL_PLACEHOLDER__
export FC_EMAILS=__EMAIL_PLACEHOLDER__
export TRADER_EMAILS=__EMAIL_PLACEHOLDER__
export VET_VISITS_EMAILS=__EMAIL_PLACEHOLDER__
export FINANCE_EMAILS=__EMAIL_PLACEHOLDER__
export DEMOGRAPHICS_EMAILS=__EMAIL_PLACEHOLDER__
export OPS_ANALYSIS_EMAILS=__EMAIL_PLACEHOLDER__
export DAX_UNAVAILABLE_EMAILS=__EMAIL_PLACEHOLDER__
export ESFIO_DAX_EMAILS=__EMAIL_PLACEHOLDER__
export D365_UNSETTLED_EMAILS=___EMAIL_PLACEHOLDER__
