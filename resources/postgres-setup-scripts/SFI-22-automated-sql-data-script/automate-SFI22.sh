...
PGPASSWORD=ppp psql -h host.docker.internal -p 5452 -U postgres -d ffc_pay_statement_data -f $(pwd)/SFI22-statements-data/ffc-pay-statement-data.sql 
...
PGPASSWORD=ppp psql -h host.docker.internal -p 5438 -U postgres -d ffc_pay_submission -f $(pwd)/SFI22-statements-data/ffc-pay-submission.sql 
...
PGPASSWORD=ppp psql -h host.docker.internal -p 5451 -U postgres -d ffc_pay_statement_generator -f $(pwd)/SFI22-statements-data/ffc-pay-statement-generator.sql 
...
PGPASSWORD=ppp psql -h host.docker.internal -p 5450 -U postgres -d ffc_pay_statement_constructor -f $(pwd)/SFI22-statements-data/ffc-pay-statement-constructor.sql 
...
PGPASSWORD=ppp psql -h host.docker.internal -p 5433 -U postgres -d ffc_pay_request_editor -f $(pwd)/SFI22-statements-data/ffc-pay-request-editor.sql 
...
PGPASSWORD=ppp psql -h host.docker.internal -p 5434 -U postgres -d ffc_pay_processing -f $(pwd)/SFI22-statements-data/ffc-pay-processing.sql 
...
PGPASSWORD=ppp psql -h host.docker.internal -p 5436 -U postgres -d ffc_pay_batch_processor -f $(pwd)/SFI22-statements-data/ffc-pay-batch-processor.sql 
